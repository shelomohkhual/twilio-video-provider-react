...
exports.initializeAnalyser = initializeAnalyser;

var _react = _interopRequireWildcard(require("react"));

var _useIsTrackEnabled = _interopRequireDefault(require("../../hooks/useIsTrackEnabled"));
...
function initializeAnalyser(stream) {
...
function AudioLevelIndicator(_ref) {
  let {
    audioTrack,
    color = 'white'
  } = _ref;
  ...
  const isTrackEnabled = (0, _useIsTrackEnabled.default)(audioTrack); // const mediaStreamTrack = useMediaStreamTrack(audioTrack);
  // useEffect(() => {
  ...
  const clipPathId = "audio-level-clip-".concat(getUniqueClipId());
  return isTrackEnabled ? /*#__PURE__*/_react.default.createElement("svg", {
...
var _default = /*#__PURE__*/_react.default.memo(AudioLevelIndicator);
